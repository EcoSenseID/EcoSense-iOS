...
import 'package:ecosense/features/pages/eco_reward/list/reward_list.dart';
...
class HorizontalDonation extends StatelessWidget {
  const HorizontalDonation(this.rewards, this.currentPoint, {super.key});
          ...
          children: [
            ...
            GestureDetector(
              onTap: () => PersistentNavBarNavigator.pushNewScreen(context,
                  screen: RewardListScreen(
                      2, 'reward_donation_title'.i18n(), currentPoint)),
              child: Row(
                children: [
